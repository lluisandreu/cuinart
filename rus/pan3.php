<?php 
	$page = "pan3";
	$titlepage ="Panorámica visual número 3";
...
if ((window.p2q_Version) && (window.p2q_Version>=2.0)) {
	...
	panorama='<panorama>';
	panorama+='<view>';
	panorama+='<start pan="131.5" tilt="-12" fov="70"/>';
	...
	panorama+='<input tile0url="assets/pans/360_3/img0.jpg" tile1url="assets/pans/360_3/img1.jpg" tile2url="assets/pans/360_3/img2.jpg" tile3url="assets/pans/360_3/img3.jpg" tile4url="assets/pans/360_3/img4.jpg" tile5url="assets/pans/360_3/img5.jpg" tilesize="1000" ><preview images="1" color="0x808080"/>';
	panorama+='</input>';
...
p2q_EmbedFlash('assets/pans/360_3/cuina 33_out.swf','100%','100%','allowFullScreen','true','FlashVars',flashvars);
