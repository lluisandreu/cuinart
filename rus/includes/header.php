...
<meta name="description" content="Дизайны кухонь, ванных комнат и шкафов " />
...
<div id="contenidor">
  <div id="capsalera">
    <div id="capsa_left">
      ...
      <li><a href="/index.php" <?php if($language == 'en'){print 'style="color:#CC6600;"';} ?>>Eng </a></li>
    ...
    <div id="capsa_right">
    <a href="/rus/index.php"><img src="../images/capsa_right_image.jpg" width="700" height="100" alt="Logotip Cuinart" /></a>
    </div>
  </div>